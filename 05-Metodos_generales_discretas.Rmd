...
Este algoritmo está implementado en la función  `r cite_fsimres("rpmf")` del paquete `r cite_simres()` (fichero [*rpmf.R*](R/rpmf.R)), que ademas devuelve el número de comparaciones en un atributo `ncomp`:
...
Este algoritmo está implementado en la función  `r cite_fsimres("rpmf.table", pkg = TRUE)` (fichero [*rpmf.R*](R/rpmf.R)) y devuelve también el número de comparaciones en un atributo `ncomp`:
...
Este método también está implementado en la función  `r cite_fsimres("rpmf.alias", pkg = TRUE)` (fichero [*rpmf.R*](R/rpmf.R)), empleando código R menos eficiente:
