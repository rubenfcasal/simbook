...
[^04-inversion-1]: Esta distribución también se puede generar fácilmente simulando una distribución exponencial y asignando un signo positivo o negativo con equiprobabilidad (ver Ejemplo \@ref(exm:dexp-mix)) y función `r cite_fgithub(rdexp, lnk = "ddexp", full = TRUE)` (fichero [*ddexp.R*](R/ddexp.R)).
