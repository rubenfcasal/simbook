...
```{r ks-boot-plot, cache=TRUE, fig.dim = c(12, 12), out.width = "90%", fig.cap="Distribución del p-valor (izquierda) y tamaño (proporción de rechazos bajo la hipótesis nula; derecha), aproximados por  Monte Carlo, para el contraste de Kolmogorov-Smirnov (arriba) y el correspondiente contraste boostrap paramétrico (abajo)."}
# Valores iniciales
set.seed(1)
nx <- 30
ratex <- 1
