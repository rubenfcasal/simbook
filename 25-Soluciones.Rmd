...
Generamos el correspondiente gráfico `r cite_fig(simpiplot)` (los puntos con color negro tienen distribución uniforme en el círculo unidad; esto está relacionado con el método de aceptación-rechazo, ver Ejemplo \@ref(exm:ar-esfera), o con el denominado método *hit-or-miss*).
...
```{r mixta-cuantil-plot-sol, fig.cap="Función de distribución mixta (con discontinuidades en 0 y 1/5)."}
