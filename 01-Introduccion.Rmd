...
```{r randtoolbox, fig.cap='Secuencias cuasi-aleatorias bidimensionales obtenidas con los métodos de Halton (izquierda), Sobol (centro) y Torus (derecha).', fig.width=12, fig.height=5, message=FALSE}
library(randtoolbox)
n <- 2000
