...
Por ejemplo, en el caso de la máquina RAND, fallos mecánicos en el sistema de grabación de los datos causaron problemas de aleatoriedad \citep[118]{hacking1965}.
...
\item
  Si \(\mathcal{L}(\hat{\theta} | \mathbf{x}) \cdot U \leq
...
A partir de la propiedad \citep[ver e.g.][488-489]{devroye1986}
...
Esto está relacionado con la \emph{maldición de la dimensionalidad} (curse of dimensionality), a medida que aumenta el número de dimensiones el volumen de la ``frontera'' crece exponencialmente \citep[ver p.e.][sec.~1.4]{mpaebook2024}.
\end{example}
...
de donde se deduce \citep[ver e.g.][88]{cao2002} que:
