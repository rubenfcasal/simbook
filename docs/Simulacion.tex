...
\BeginKnitrBlock{conjecture}[Método de inversión]
...
\BeginKnitrBlock{conjecture}[Método de aceptación-rechazo; Von Neuman, 1951]
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{image}\NormalTok{(kc, }\DataTypeTok{val=}\NormalTok{kc}\OperatorTok{$}\NormalTok{simul[,}\DecValTok{4}\NormalTok{], }\DataTypeTok{main=}\StringTok{"simul. cond. 4"}\NormalTok{, }\DataTypeTok{zlim=}\NormalTok{zlim)}
\end{Highlighting}
\end{Shaded}
