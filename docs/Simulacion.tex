...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Máximo error porcentual absoluto}
...
\hypertarget{transcuant-directo}{%
\section{Cálculo directo de la función cuantil}\label{transcuant-directo}}
...
\caption{Esquema de la idea del boostrap (de Efron).}\label{fig:unnamed-chunk-2}
\end{figure}
