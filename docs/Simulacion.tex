...
En la Sección \hyperref[links]{Enlaces} de las Referencias se incluyen recursos adicionales, incluyendo algunos que pueden ser útiles para el aprendizaje de R.
...
Por ejemplo, los procesadores recientes de Intel o de AMD incorporan esta funcionalidad (ver e.g.~\href{http://software.intel.com/en-us/articles/intel-digital-random-number-generator-drng-software-implementation-guide}{Intel Digital Random Number Generator (DRNG) Software Implementation Guide}).
...
\begin{verbatim}
 ...
 ##  $ tic         : num  2.37 2.37 2.37 2.37 2.37 2.37 2.37 2.37 2.37 2.39
 ##  $ toc         : num  2.37 2.37 2.37 2.37 2.37 2.37 2.37 2.37 2.39 2.39
 ##  $ msg         : chr  "1" "2" "3" "4" ...
...
Este método está implementado\footnote{Aunque de forma no muy eficiente. Para evitar problemas computacionales, se recomienda realizar el cálculo de los valores empleando el método de Schrage (ver Bratley \emph{et al.}, 1987; L'Ecuyer, 1988).} en la función \href{https://rubenfcasal.github.io/simres/reference/set.rng.html}{\texttt{rlcg()}} del paquete \href{https://rubenfcasal.github.io/simres}{\texttt{simres}}, imitando el funcionamiento del generador uniforme de R (fichero \href{R/rng.R}{\emph{rng.R}}):
...
\begin{verbatim}
 ...
 ##   return(u)
 ## }
 ## <bytecode: 0x0000011af9e219a0>
 ## <environment: namespace:simres>
\end{verbatim}

Aunque puede resultar más cómodo, especialmente si se van a generar múltiples secuencias, utilizar la función \texttt{set.rng()} con \texttt{type\ =\ "lcg"} para seleccionar este generador y posteriormente \texttt{rng()} para obtener las secuencias.
...
Se han propuesto diversas pruebas (ver Sección \ref{calgen}) para determinar si un generador tiene problemas de este tipo y se han realizado numerosos estudios para determinadas familias \citep[e.g.][estudiaron los multiplicadores adecuados para \(m=2^{31}-1\)]{park1988}.
...
Uno de los contrastes más conocidos es el test chi-cuadrado de bondad de ajuste (\href{https://rdrr.io/r/stats/chisq.test.html}{\texttt{chisq.test()}} para el caso discreto).
...
\FunctionTok{curve}\NormalTok{(}\FunctionTok{dchisq}\NormalTok{(x, }\DecValTok{99}\NormalTok{), }\AttributeTok{col =} \StringTok{"blue"}\NormalTok{, }\AttributeTok{add =} \ConstantTok{TRUE}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{abline}\NormalTok{(}\AttributeTok{h =}\NormalTok{ p, }\AttributeTok{col =} \StringTok{"blue"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
\begin{center}\includegraphics[width=0.7\linewidth]{03-Analisis_resultados_files/figure-latex/unnamed-chunk-11-1} \end{center}
...
\citet{odeh1974} consideraron la siguiente función auxiliar\footnote{R emplea una aproximación similar, basada en el algoritmo de \citet{wichura1988} más preciso, y que está implementado en el fichero fuente \href{https://svn.r-project.org/R/trunk/src/nmath/qnorm.c}{qnorm.c}.}:
...
\item
  Si \(L(\mathbf{x}|\hat{\theta})\cdot U \leq
...
{\centering \includegraphics[width=0.7\linewidth]{images/squeeze} 
...
\def\labelenumi{\arabic{enumi}.}
\item
  Simular \(V_1,V_2,\ldots,V_d \sim  \mathcal{U}\left(
...
\def\labelenumi{\arabic{enumi}.}
\item
  Simular \(X_1\) con densidad \(f_1\left(
  x_1\right)  =\frac{2}{\pi}\sqrt{1-x_1^2}1_{\{|x_1|\leq1\}}\).
\item
  Simular \(X_2\) con densidad \(\mathcal{U}\left(
  -\sqrt{1-X_1^2},\sqrt{1-X_1^2}\right)\).
\item
  Devolver \(\mathbf{X}=\left( X_1,X_2\right)
  ^t\).
\end{enumerate}
...
\item
  Hacer \(X_2 =\mu_2 + \sigma_2 \rho Z_1
...
{\centering \includegraphics[width=0.7\linewidth]{06-Simulacion_multidimensional_files/figure-latex/co2-forecast-1} 
...
De hecho este estimador es empleado muchas veces en lugar del anterior ya que, aunque en general no es insesgado, puede ser más eficiente si \(w(Y)\) y \(w(Y)h(Y)\) están altamente correlacionadas \citep[e.g.][35]{liu2004}.
...
\begin{center}\includegraphics[width=0.7\linewidth]{07-Monte_Carlo_files/figure-latex/unnamed-chunk-13-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{07-Monte_Carlo_files/figure-latex/unnamed-chunk-17-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{07-Monte_Carlo_files/figure-latex/unnamed-chunk-20-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{07-Monte_Carlo_files/figure-latex/unnamed-chunk-34-1} \end{center}
...
\end{Shaded}
  ...
  \begin{center}\includegraphics[width=0.7\linewidth]{07-Monte_Carlo_files/figure-latex/unnamed-chunk-39-1} \end{center}
...
\end{Shaded}
  ...
  \begin{center}\includegraphics[width=0.7\linewidth]{07-Monte_Carlo_files/figure-latex/unnamed-chunk-43-1} \end{center}
\end{enumerate}
...
\end{Shaded}
  ...
  \begin{center}\includegraphics[width=0.7\linewidth]{07-Monte_Carlo_files/figure-latex/unnamed-chunk-46-1} \includegraphics[width=0.7\linewidth]{07-Monte_Carlo_files/figure-latex/unnamed-chunk-46-2} \end{center}
\item
...
\end{Shaded}
  ...
  \begin{center}\includegraphics[width=0.7\linewidth]{07-Monte_Carlo_files/figure-latex/unnamed-chunk-51-1} \includegraphics[width=0.7\linewidth]{07-Monte_Carlo_files/figure-latex/unnamed-chunk-51-2} \end{center}
\item
...
\end{Shaded}
  ...
  \begin{center}\includegraphics[width=0.7\linewidth]{07-Monte_Carlo_files/figure-latex/unnamed-chunk-55-1} \includegraphics[width=0.7\linewidth]{07-Monte_Carlo_files/figure-latex/unnamed-chunk-55-2} \end{center}
\item
...
\end{Shaded}
  ...
  \begin{center}\includegraphics[width=0.7\linewidth]{07-Monte_Carlo_files/figure-latex/unnamed-chunk-59-1} \includegraphics[width=0.7\linewidth]{07-Monte_Carlo_files/figure-latex/unnamed-chunk-59-2} \end{center}
\item
...
\end{Shaded}
  ...
  \begin{center}\includegraphics[width=0.7\linewidth]{07-Monte_Carlo_files/figure-latex/unnamed-chunk-61-1} \end{center}
...
\end{Shaded}
  ...
  \begin{center}\includegraphics[width=0.7\linewidth]{07-Monte_Carlo_files/figure-latex/unnamed-chunk-64-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{08-Reduccion_varianza_files/figure-latex/unnamed-chunk-1-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{08-Reduccion_varianza_files/figure-latex/unnamed-chunk-3-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{08-Reduccion_varianza_files/figure-latex/unnamed-chunk-8-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{08-Reduccion_varianza_files/figure-latex/unnamed-chunk-10-1} \end{center}
...
\item
  Obtener \(\mathbf{X}^{\ast}=\left( X_1^{\ast},\ldots
  ,X_n^{\ast} \right)\)
\item
...
\item
  Calcular \(R^{\ast}=R\left( \mathbf{X}^{\ast},\hat{F} \right)
...
\begin{center}\includegraphics[width=0.7\linewidth]{22-Bondad_ajuste_Aleatoriedad_files/figure-latex/unnamed-chunk-2-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{22-Bondad_ajuste_Aleatoriedad_files/figure-latex/unnamed-chunk-3-1} \includegraphics[width=0.7\linewidth]{22-Bondad_ajuste_Aleatoriedad_files/figure-latex/unnamed-chunk-3-2} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{22-Bondad_ajuste_Aleatoriedad_files/figure-latex/unnamed-chunk-6-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{22-Bondad_ajuste_Aleatoriedad_files/figure-latex/unnamed-chunk-10-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{23-Integracion_numerica_files/figure-latex/unnamed-chunk-1-1} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{25-Soluciones_files/figure-latex/unnamed-chunk-13-1} \end{center}
...
\end{Shaded}
  ...
  \begin{center}\includegraphics[width=0.7\linewidth]{25-Soluciones_files/figure-latex/unnamed-chunk-18-1} \end{center}
