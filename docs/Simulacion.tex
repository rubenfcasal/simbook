...
\newtheoremstyle{break}
  ...
  {\bfseries}{\vspace{\topsep}}%      Theorem head font, Punctuation after theorem head
...
##  $ tic: num  5.98 5.98 5.98 5.98 5.98 5.98 5.98 5.98 5.98 5.98
##  $ toc: num  5.98 5.98 5.98 5.98 5.98 5.98 5.98 5.98 5.98 5.98
##  $ msg: chr  "1" "2" "3" "4" ...
\end{verbatim}
...
\FunctionTok{curve}\NormalTok{(}\FunctionTok{dbeta}\NormalTok{(x, s1, s2), }\DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{)}
...
\FunctionTok{abline}\NormalTok{(}\AttributeTok{h =}\NormalTok{ c, }\AttributeTok{lty =} \DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Intervalo de probabilidad al 95\% (intervalo de credibilidad bayesiano)}
...
\end{Shaded}
  ...
  \begin{center}\includegraphics[width=0.7\linewidth]{05-Metodos_generales_continuas_files/figure-latex/unnamed-chunk-15-1} \end{center}
\item
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{res }\OtherTok{\textless{}{-}} \FunctionTok{data.frame}\NormalTok{(}\AttributeTok{x =}\NormalTok{ x, }\AttributeTok{pteor =}\NormalTok{ fmp, }\AttributeTok{psim =} \DecValTok{0}\NormalTok{)}
\NormalTok{res.sim }\OtherTok{\textless{}{-}} \FunctionTok{table}\NormalTok{(rx)}\SpecialCharTok{/}\NormalTok{nsim}
\NormalTok{index }\OtherTok{\textless{}{-}} \FunctionTok{match}\NormalTok{(}\FunctionTok{names}\NormalTok{(res.sim), x)}
\NormalTok{res}\SpecialCharTok{$}\NormalTok{psim[index] }\OtherTok{\textless{}{-}}\NormalTok{ res.sim}
\end{Highlighting}
\end{Shaded}
