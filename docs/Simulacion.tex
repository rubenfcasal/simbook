...
\subsection{Método de Box-Müller}\label{metodo-de-box-muller}
...
multivariantes}\label{simulacion-de-distribuciones-multivariantes}
...
independientes}\label{simulacion-de-componentes-independientes}
