...
\BeginKnitrBlock{remark}
\iffalse{} {Nota: } \fi{}Para evitar problemas computacionales, se recomienda emplear
el método de Schrage (ver Bratley \emph{et al.}, 1987; L'Ecuyer, 1988)
\EndKnitrBlock{remark}
...
\begin{itemize}
\item
  \(c=0\), \(a=2^{16}+3=65539\) y \(m=2^{31}\), generador \texttt{RANDU} de IBM
...
\protect\hypertarget{thm:unnamed-chunk-4}{}{\label{thm:unnamed-chunk-4} }(Hull y Dobell, 1962)
...
Por ejemplo, el conjunto de datos \texttt{randu} contiene 400 tripletas de números sucesivos obtenidos con la implementación en VAX/VMS 1.5 (1977).
...
\end{Shaded}
  ...
  \begin{center}\includegraphics[width=0.7\linewidth]{05-Metodos_generales_continuas_files/figure-latex/unnamed-chunk-17-1} \end{center}
\item
...
(i.e.~\(\frac{\partial ^{2}}{\partial x^{2}}\log f\left( x\right) <0, ~\forall x\)).
...
\protect\hypertarget{cnj:unnamed-chunk-20}{}{\label{cnj:unnamed-chunk-20} \iffalse (de simulación mediante una tabla guía) \fi{} }
...
\protect\hypertarget{exm:unnamed-chunk-26}{}{\label{exm:unnamed-chunk-26} \iffalse (distribución de Poisson) \fi{} }
\EndKnitrBlock{example}
...
\protect\hypertarget{exm:unnamed-chunk-27}{}{\label{exm:unnamed-chunk-27} \iffalse (distribución uniforme discreta) \fi{} }
\EndKnitrBlock{example}
...
\protect\hypertarget{exm:unnamed-chunk-28}{}{\label{exm:unnamed-chunk-28} \iffalse (distribución geométrica) \fi{} }
\EndKnitrBlock{example}
...
\protect\hypertarget{cnj:unnamed-chunk-2}{}{\label{cnj:unnamed-chunk-2} \iffalse (de simulación de normales independientes) \fi{} }
...
\protect\hypertarget{exm:unnamed-chunk-5}{}{\label{exm:unnamed-chunk-5} \iffalse (distribución bidimensional acotada) \fi{} }
\EndKnitrBlock{example}
...
\protect\hypertarget{exm:unnamed-chunk-6}{}{\label{exm:unnamed-chunk-6} \iffalse (distribución uniforme en la esfera) \fi{} }
\EndKnitrBlock{example}
...
\protect\hypertarget{cnj:unnamed-chunk-8}{}{\label{cnj:unnamed-chunk-8} \iffalse (de simulación de una normal multivariante) \fi{} }
...
con \(0\leq x\leq1\) y \(Cov(\varepsilon\left( x \right) , \varepsilon\left( y \right) ) = e^{-\left\Vert x-y \right\Vert }\),
...
\protect\hypertarget{cnj:unnamed-chunk-12}{}{\label{cnj:unnamed-chunk-12} \iffalse (de simulación mediante distribuciones condicionadas) \fi{} }
...
\protect\hypertarget{exm:unnamed-chunk-13}{}{\label{exm:unnamed-chunk-13} \iffalse (distribución uniforme en el círculo unitario) \fi{} }
\EndKnitrBlock{example}
...
\protect\hypertarget{exm:unnamed-chunk-14}{}{\label{exm:unnamed-chunk-14} \iffalse (distribución normal bidimensional) \fi{} }
\EndKnitrBlock{example}
...
\protect\hypertarget{cnj:unnamed-chunk-15}{}{\label{cnj:unnamed-chunk-15} \iffalse (de simulación de una normal bidimensional) \fi{} }
...
\protect\hypertarget{cnj:unnamed-chunk-16}{}{\label{cnj:unnamed-chunk-16} \iffalse (de simulación condicional) \fi{} }
...
\protect\hypertarget{exm:unnamed-chunk-19}{}{\label{exm:unnamed-chunk-19} \iffalse (simulación condicional de datos espaciales) \fi{} }
\EndKnitrBlock{example}
...
\protect\hypertarget{cnj:unnamed-chunk-24}{}{\label{cnj:unnamed-chunk-24} \iffalse (de simulación bidimensional mediante cópulas) \fi{} }
...
\end{Shaded}
  ...
  \begin{center}\includegraphics[width=0.7\linewidth]{07-Simulacion_multidimensional_files/figure-latex/unnamed-chunk-30-1} \end{center}
...
\end{Shaded}
  ...
  \begin{center}\includegraphics[width=0.7\linewidth]{07-Simulacion_multidimensional_files/figure-latex/unnamed-chunk-30-2} \end{center}
...
\begin{center}\includegraphics[width=0.7\linewidth]{07-Simulacion_multidimensional_files/figure-latex/unnamed-chunk-48-1} \end{center}
...
\end{Shaded}
  ...
  \iffalse{} {Nota: } \fi{}La fila \texttt{muestras{[}i,{]}} contiene las observaciones de la i-ésima muestra y
