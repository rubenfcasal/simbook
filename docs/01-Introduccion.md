...
Si se puede obtener la solución de forma análitica, esta suele ser exacta (aunque en ocasiones solo se dispone de soluciones aproximadas/asintóticas) y a menudo la resolución también es rápida.
