...
```{example, label="estr-exp", name="Muestreo estratificado de una exponencial"}
``` 
...
```{exercise, label="mc-integrale", name="Integración Monte Carlo con estratificación"}
``` 
...
```{exercise, label="mc-integral-contr", name="Integración Monte Carlo con variables de control"}
``` 
...
```{exercise, label="mc-int-ainv", name="propuesto"}
``` 
