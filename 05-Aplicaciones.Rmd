...
# Pendiente: poner nombre a los chunks...
```
...
la correspondiente media y desv. tip.
```
...
```{remark}
También es habitual simular este tipo de datos generando un porcentaje alto de valores (95%) de la distribución base ($N(0,1)$) y el resto (5%) de la distibución "contaminadora" ($N(3,3^2)$), aunque se suele considerar un porcentaje de contaminación del 1% o inferior.
```
