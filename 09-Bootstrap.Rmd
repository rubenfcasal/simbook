...
```{r plot-res-boot, fig.dim=c(12, 6), out.width="90%", fig.cap='Gráficos de diagnóstico de los resultados bootstrap para la media muestral de los tiempos de vida de microorganismos.'}
plot(res.boot)
```
...
```{r plot-boot-multi, fig.dim=c(12, 6), out.width="90%", fig.cap='Gráficos de diagnóstico para la distribución bootstrap del coeficiente de correlación.'}
library(boot)
