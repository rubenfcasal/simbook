...
Como se mostró en el Capítulo \@ref(monte-carlo), para calcular la aproximación por integración Monte Carlo podemos emplear la función `r cite_fgithub(mc.integral)` del paquete `r cite_github()` (fichero [*mc.plot.R*](R/mc.plot.R)):
