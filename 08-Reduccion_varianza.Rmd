...
Como se mostró en el Capítulo \@ref(monte-carlo), para calcular la aproximación por integración Monte Carlo podemos emplear la función `r cite_fsimres("mc.integral")` del paquete `r cite_simres()` (fichero [*mc.plot.R*](R/mc.plot.R)):
