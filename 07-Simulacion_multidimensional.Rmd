...
```{example, name="simulación de normales independientes"}
```
...
```{conjecture, name="de simulación de normales independientes" }
...
```{r fig.cap="Densidades marginales de las componentes."}
...
```{example, name="distribución bidimensional acotada"}
``` 
...
```{example, name="distribución uniforme en la esfera"}
``` 
...
```{conjecture, name="de simulación de una normal multivariante" }
<!--- Los siguientes comandos añaden una línea en html, word y un salto vertical en pdf -->
<br> \vspace{0.5cm}
...
```
y para simular `nsim`:
```{r , fig.cap = "Realizaciones del proceso funcional."}
...
```{conjecture, name="de simulación mediante distribuciones condicionadas" }
<!--- Los siguientes comandos añaden una línea en html, word y un salto vertical en pdf -->
<br> \vspace{0.5cm}
...
```{conjecture, name="de simulación de una normal bidimensional" }
<!--- Los siguientes comandos añaden una línea en html, word y un salto vertical en pdf -->
<br> \vspace{0.5cm}
...
```{conjecture, name="de simulación condicional" }
<!--- Los siguientes comandos añaden una línea en html, word y un salto vertical en pdf -->
<br> \vspace{0.5cm}
...
```{example, name="simulación condicional de datos funcionales o temporales"}
```
...
```{r, fig.cap = "Realizaciones condicionales del proceso funcional."}
...
```{conjecture, name="de simulación bidimensional mediante cópulas" }
<!--- Los siguientes comandos añaden una línea en html, word y un salto vertical en pdf -->
<br> \vspace{0.5cm}
