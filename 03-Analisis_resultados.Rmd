...
Podemos generar este gráfico empleando la función `r cite_fsimres("conv.plot", lnk = "mc.plot")` (o `r cite_fsimres("mc.plot")`) del paquete `r cite_simres()` (fichero [*mc.plot.R*](R/mc.plot.R)).
