...
Podemos generar este gráfico empleando la función `r cite_fgithub(conv.plot, lnk = "mc.plot")` (o `r cite_fgithub(mc.plot)`) del paquete `r cite_github()` (fichero [*mc.plot.R*](R/mc.plot.R)).
