...
```{r cuantil-movie, echo=FALSE, out.width = "80%", fig.cap="Ilustración de la simulación de una distribución discreta mediante transformación cuantil."}
if (is_latex()) {
...
```{conjecture, name='"Robin Hood" de inicialización; Kronmal y Peterson, 1979', label="robin-hood" }
<br>
...
```{conjecture, name="método alias de simulación; Walker, 1977", label="walker"}
<br>
